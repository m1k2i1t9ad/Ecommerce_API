...
class ProductViewSet(ModelViewSet):
    queryset = Product.objects.prefetch_related('images').all() #the prefetch_related method here will eager-load our product with their images preventing the database to have many queries
...
class ProductImageViewSet(ModelViewSet):
    ...
    # queryset=ProductImage.objects.all() #this is commented cuz of the below reason:
    #since we don't want to return all the product images in the database,we overwrite the get_queryset method:
